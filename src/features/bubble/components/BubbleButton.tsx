  ...
  return (
    <Show when={!isSmallScreen() || !props.isBotOpened} keyed>
      <button
        ...
        class={`fixed shadow-xl rounded-full hover:scale-110 active:scale-95 transition-transform duration-200 flex justify-center items-center animate-fade-in ${!props.isBotOpened ? 'animate-pulse-slow' : ''}`}
        style={{
